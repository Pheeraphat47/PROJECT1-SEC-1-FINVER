...
<template>
  ...
  <div class="flex justify-center transition-all duration-500 ease-in-out"
    :class="isDark ? 'bg-gray-800' : 'bg-rgb(243, 216, 254)'">
    <div class="flex justify-center p-5 pt-[5em]">
      ...
      <div class="shadow-xl card w-96 bg-base-100" :class="isDark ? 'bg-gray-400' : 'bg-white '">
        ...
        <div class="flex justify-center pt-[1.7em]">
          <svg xmlns="http://wwww3.org/2000/svg" width="2em" height="2em" viewBox="0 0 1200 1700"
        ...
        <figure class="px-10 mt-10">
          <swiper :modules="modules" :slides-per-view="1" :space-between="10" :scrollbar="{ draggable: true }"
            ...
            <swiper-slide @click="goToNextSlide"><img src="./assets/img/taned_two.webp" alt="Taned2"
