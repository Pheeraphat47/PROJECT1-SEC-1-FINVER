		...
		<div class="flex justify-center p-5 pt-[5em]">
			...
			<div class="shadow-xl card w-96 bg-base-100">
				...
				<div class="grid grid-cols-3 card-body">
					<h2 class="col-span-2 card-title">ParkSeoGame</h2>
					<!-- Dropdown -->
					<button
					...
					<!-- Desc -->
					<p class="col-span-3">The most handsome guy in KMUTT</p>
					<!-- Hidden Desc -->
					<div
						v-if="showDescriptions"
						class="col-span-3 max-h-[200px] overflow-y-auto"
					>
						<p v-for="(description, key) in descriptions" :key="key">
							{{ description }}
						</p>
					</div>
					<!-- Dislike Icon -->
