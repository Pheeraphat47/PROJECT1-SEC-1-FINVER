...
<template>
  ...
  <div
    ...
    :class="{ '': isNavbarWhite, 'bg-pink-300': !isNavbarWhite }"
    ...
    <div class="flex items-center justify-center">
      <div>
        ...
        <dialog id="modal" class="modal">
          <div class="modal-box">
            ...
            <div
              class="chats flex-col items-center justify-center gap-5 cursor-pointer"
            >
              <div
                v-for="(profile, index) in likedProfiles"
                :key="index"
                class="chat-bubbles m-2"
              >
                <img
                  v-if="
      ...
      <div v-if="Profiles.length === 0">
        <div class="card w-96 shadow-xl">
          ...
          >
            <form action="" class="">
              <label for="review" class="flex justify-center"
              ...
              <input
                ...
                name="review"
                id="review"
                class="text-center border-pink-400 border-4"
